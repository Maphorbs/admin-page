            ...
            <?php endif; ?>
              ...
              <label class="control-label">Password confirmation</label>
               ...
               <?php if (isset($errors['passwordConf'])): ?>
                ...
                <input type="file" name="profile_picture" id="profile_input" value="" style="display: none;"> </div> 
             <div class="form-group"> 
                <button type="submit" name="signup_btn" class="btn btn-success btn-block">Sign up</button> </div> 
